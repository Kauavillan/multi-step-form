...
export default function Home() {
  ...
  const [savedAddOnsPrices, setSavedAddOnsPrices] = useState("");
  ...
  function saveDataThird(checkboxes, totalPrice, prices){
    setSavedCheckboxes(checkboxes);
    setSavedPrice(totalPrice);
    setSavedAddOnsPrices(prices);
  }
  return (
      ...
      <div className={styles.content}>      
        ...
        <div className={styles.formWrapper}>
          ...
          { step ==1 ?
            ...
            :
            step == 3 ?
            <ThirdStep actionContinue={handleContinue} savedCheckboxes={savedCheckboxes} isYearly={savedIsYearly} savedPrice={savedPrice} savedAdOnsPrices={savedAddOnsPrices} saveData={saveDataThird} actionReturn={handleReturn}/>
            :step == 4 ?
            <FourthStep actionContinue={handleContinue} actionReturn={handleReturn} returnToPlan={returnToPlan} savedIsYearly={savedIsYearly} savedArcadeCost={savedArcadeCost} savedAdvancedCost={savedAdvancedCost} savedProCost={savedProCost} savedAdOnsTotalCost={savedPrice} savedAddOnsPrices={savedAddOnsPrices} savedSelectedPlan={savedSelectedPlan} selectedCheckboxes={savedCheckboxes}/>
            :step ==5 &&
